...
const DICT = {
	ja: {
		...
		// --- 一括リネーム ---
		'tree.renameBulk':       'まとめて…',
		'tree.renameBulk.title': 'レイヤ名をまとめて付け直す (連番 / 検索置換 / 前後に足す)',
		'rn.title':        'レイヤ名をまとめて付け直す',
		'rn.hint':         '探す→置き換え、先頭と末尾に足す、連番、の順にかかる。下の一覧で結果を見てから適用する。フォルダや画像の名前も変えられる。',
		'rn.target':       '対象',
		'rn.target.sel':   '選択中のレイヤ',
		'rn.target.text':  'テキストレイヤ',
		'rn.target.all':   '全レイヤ',
		'rn.count':        '{0} 枚のうち {1} 枚が変わる',
		'rn.find':         '探す',
		'rn.repl':         '置き換え',
		'rn.regex':        '正規表現',
		'rn.case':         '大文字小文字を区別',
		...
		'rn.seqAt.prefix': '先頭',
		'rn.seqSep':       '区切り',
		'rn.vars':         '「置き換え」「先頭に足す」「末尾に足す」には {n} と書くと連番が入る。桁数は {n:3} のようにその場で指定でき、{n+10} で番号をずらせる (指定が無ければ上の「桁」に従う)。',
		'rn.seqByVar':     '{n} を使っているので、自動の連番付けは止めています',
		'rn.col.kind':     '',
		'rn.col.old':      '今の名前',
		'rn.col.new':      '新しい名前',
		'rn.col.body':     '中身',
		...
		'rn.applyN':       '{0} 枚を付け直す',
		'rn.reset':        '条件を消す',
		'rn.done':         '{0} 枚の名前を変えました',
		'rn.doneFailed':   '{0} 枚を変更 / {1} 枚 失敗',
		'rn.badRegex':     '正規表現が読めない: {0}',
		'rn.emptyName':    '(空になるので変えない)',

		// --- 一覧編集 ---
		'sheet.title':     '一覧編集',
		'sheet.hint':      '本文と初期書式をまとめて書き換える。Excel からそのまま貼り付けられる (タブ区切りで配られる)。⚠ の行は本文の途中に書式指定があり、本文を書き換えるとその指定は消える。',
		'sheet.allLayers': '全レイヤを出す',
		'sheet.allLayersHint': 'フォルダや画像も行に出る。書き換えられるのはレイヤ名だけ。',
		'sheet.cols':      'コピー / 貼り付けの対象',
		'sheet.colTarget': 'この列をコピー / 貼り付けの対象にする',
		'sheet.colsText':  '本文だけ',
		'sheet.colsStyle': '書式だけ',
		'sheet.colsName':  'レイヤ名だけ',
		'sheet.colsNotName': 'レイヤ名以外',
		'sheet.colsAll':   'すべて',
		'sheet.copy':      '表をコピー',
		'sheet.copy.title': '対象の列だけをタブ区切りでコピーする (Excel にそのまま貼れる)',
		'sheet.copied':    '{0} 行 × {1} 列をコピーしました',
		'sheet.noCols':    '対象の列がひとつも選ばれていない',
		'sheet.colOff':    '「{0}」の列はコピー / 貼り付けの対象から外れている (見出しのチェックを入れる)',
		'sheet.pastedSkip': '{0} セルを貼り付けました ({1} セルはテキストレイヤでないので飛ばした)',
		'sheet.fontPick':  'フォントを選ぶ (この PSD が使っているぶんと ★ で登録したぶん)',
		'sheet.fontMore':  'ほかのフォントから選ぶ…',
		'sheet.fontNone':  '候補がありません (★ で登録するか、下から選ぶ)',
		'sheet.fontHint':  '候補はこの PSD が使っているフォントと ★ で登録したもの。他は … から',
		'sheet.fontSet':   'フォントを {0} にしました (まだ反映していない)',
		'sheet.col.name':  'レイヤ名',
		'sheet.col.text':  '本文',
		'sheet.col.font':  'フォント',
		'sheet.col.size':  'サイズ',
		...
		'sheet.doneRenamed': ' / レイヤ名 {0} 件',
		'sheet.doneRenamedOnly': 'レイヤ名を {0} 件変えました',
		...
		'dlg.saveGo':      '保存',
		'dlg.saveHint':    '編集していないレイヤはバイト単位でそのまま保持されます。表示 ON/OFF はプレビュー用なので保存されません。PSD 末尾の合成画像は空にして書き出します (Photoshop での表示には影響しません)。',
	...
	en: {
		...
		'dlg.fontForSheet': 'Target: the row in the list',
		...
		'tree.renameBulk':       'Batch…',
		'tree.renameBulk.title': 'Rename layers in bulk (numbering / find and replace / prefix and suffix)',
		'rn.title':        'Rename layers in bulk',
		'rn.hint':         'Rules run in order: find and replace, then the prefix and suffix, then the number. Check the list below before applying. Folder and image names can be changed too.',
		'rn.target':       'Layers',
		'rn.target.sel':   'Selected',
		'rn.target.text':  'Text layers',
		'rn.target.all':   'Every layer',
		'rn.count':        '{1} of {0} layer(s) change',
		'rn.find':         'Find',
		'rn.repl':         'Replace with',
		'rn.regex':        'Regular expression',
		'rn.case':         'Match case',
		'rn.prefix':       'Add to the front',
		'rn.suffix':       'Add to the end',
		'rn.seq':          'Number them',
		'rn.seqStart':     'From',
		'rn.seqPad':       'Digits',
		'rn.seqAt':        'Put it',
		'rn.seqAt.suffix': 'at the end',
		'rn.seqAt.prefix': 'at the front',
		'rn.seqSep':       'Separator',
		'rn.vars':         'Write {n} in "Replace with", "Add to the front" or "Add to the end" to drop the number in. Set the width inline with {n:3}, and shift it with {n+10} (without a width it follows "Digits" above).',
		'rn.seqByVar':     'Automatic numbering is off while {n} is in use',
		'rn.col.kind':     '',
		'rn.col.old':      'Now',
		'rn.col.new':      'After',
		'rn.col.body':     'Contents',
		'rn.apply':        'Rename',
		'rn.applyN':       'Rename {0} layer(s)',
		'rn.reset':        'Clear the rules',
		'rn.done':         'Renamed {0} layer(s)',
		'rn.doneFailed':   'Renamed {0} / {1} failed',
		'rn.badRegex':     'Cannot read that regular expression: {0}',
		'rn.emptyName':    '(would be empty — left alone)',
		...
		'sheet.allLayers': 'Show every layer',
		'sheet.allLayersHint': 'Folders and images appear as rows too. Only their name can be changed.',
		...
		'sheet.colsName':  'Layer name only',
		'sheet.colsNotName': 'Everything but the name',
		'sheet.colsAll':   'All',
		'sheet.copy':      'Copy table',
		'sheet.copy.title': 'Copy the selected columns as tab-separated text (paste straight into Excel)',
		'sheet.copied':    'Copied {0} row(s) × {1} column(s)',
		'sheet.noCols':    'No column is selected',
		'sheet.colOff':    'The "{0}" column is not a copy / paste target — tick it in the header',
		'sheet.pastedSkip': 'Pasted {0} cell(s) ({1} skipped — not a text layer)',
		'sheet.fontPick':  'Pick a font (the ones this PSD uses plus the starred ones)',
		'sheet.fontMore':  'Pick another font…',
		'sheet.fontNone':  'Nothing to suggest yet — star some fonts, or pick below',
		'sheet.fontHint':  'Suggestions are the fonts this PSD uses plus the ★ ones — use … for the rest',
		'sheet.fontSet':   'Font set to {0} (not applied yet)',
		'sheet.col.name':  'Layer name',
		'sheet.col.text':  'Body',
		'sheet.col.font':  'Font',
		'sheet.col.size':  'Size',
		...
		'sheet.doneRenamed': ' / {0} layer name(s)',
		'sheet.doneRenamedOnly': 'Renamed {0} layer(s)',
		...
		'dlg.saveGo':      'Save',
		'dlg.saveHint':    'Layers you did not edit are written back byte for byte. Visibility toggles are preview-only and are not saved. The flattened composite at the end of the PSD is written empty (this does not affect what Photoshop shows).',
