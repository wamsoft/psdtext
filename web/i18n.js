...
const DICT = {
	ja: {
		...
		'edit.italic':     '斜体 (選択範囲)',
		'edit.under':      '下線 (選択範囲)',
		'edit.styleHint':  '書式は本文中のタグで表す。編集欄で範囲を選んでからボタンを押すとタグが入る。',
		'edit.pos':        '位置',
		...
		'dlg.csvHint':     'lyid 列でレイヤを照合します (並べ替えや改名に強い)。lyid が無い行は path 列で照合します。text 列には書式タグを含められます。',
		'dlg.csvDry':      '確認だけ',
		'dlg.csvApply':    '反映する',
		'dlg.saveTitle':   '保存',
		...
		'msg.fontAdded':   'フォント「{0}」を候補に追加しました',
	...
	en: {
		...
		'edit.bold':       'Bold (selection)',
		'edit.italic':     'Italic (selection)',
		'edit.under':      'Underline (selection)',
		'edit.styleHint':  'Formatting is expressed as tags inside the body. Select a range and press a button to insert them.',
		'edit.pos':        'Position',
		...
		'dlg.csvHint':     'Layers are matched by the lyid column (robust against reordering and renaming). Rows without an lyid fall back to the path column. The text column may contain formatting tags.',
		'dlg.csvDry':      'Check only',
		'dlg.csvApply':    'Apply',
		'dlg.saveTitle':   'Save',
		...
		'msg.fontAdded':   'Added the font "{0}" to the candidates',
